    ...
    public class EzerealWheelFrictionController : MonoBehaviour
    {
        ...
        void SetSidewaysFriction()
        {
            fLWSidewaysFriction = new WheelFrictionCurve
            {
                ...
                stiffness = ezerealCarController.frontLeftWheelCollider.sidewaysFriction.stiffness * 1.4f
            };
            ...
            fRWSidewaysFriction = new WheelFrictionCurve
            {
                ...
                stiffness = ezerealCarController.frontRightWheelCollider.sidewaysFriction.stiffness * 1.4f
            };
            ...
            rLWSidewaysFriction = new WheelFrictionCurve
            {
                ...
                stiffness = ezerealCarController.rearLeftWheelCollider.sidewaysFriction.stiffness * 1.3f
            };
